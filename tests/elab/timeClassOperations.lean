...
def now := PlainDateTime.ofWallTime (WallTime.ofDuration ⟨1724859638, .mk ⟨907328169, by decide⟩, by decide⟩)
def after := PlainDateTime.ofWallTime (WallTime.ofDuration ⟨1724859639, .mk ⟨907641224, by decide⟩, by decide⟩)
