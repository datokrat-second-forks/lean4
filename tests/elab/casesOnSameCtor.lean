...
[Compiler.saveMono] size: 7
    def _private.elab.casesOnSameCtor.0._eval @&_y.1 @&_y.2 _y.3 : EST.Out Exception lcAny PUnit :=
      let _x.4 := "List";
      ...
      let _x.10 := Lean.Elab.Command.liftTermElabM._redArg _f.9 _y.1 _y.2 _y.3;
      return _x.10
-/
#guard_msgs in
