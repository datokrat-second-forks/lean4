...
[Compiler.saveMono] size: 8
    def _private.elab.emptyLcnf.0._eval @&_y.1 @&_y.2 _y.3 : EST.Out Lean.Exception lcAny PUnit :=
      let _x.4 := "f";
      ...
      let _x.11 := Lean.Elab.Command.liftTermElabM._redArg _f.10 _y.1 _y.2 _y.3;
      return _x.11
-/
#guard_msgs in
