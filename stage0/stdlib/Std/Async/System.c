...
lean_ctor_set(v___x_1405_, 2, v___y_1409_);
lean_ctor_set(v___x_1405_, 1, v___y_1408_);
...
lean_ctor_set(v_reuseFailAlloc_1416_, 1, v___y_1408_);
lean_ctor_set(v_reuseFailAlloc_1416_, 2, v___y_1409_);
