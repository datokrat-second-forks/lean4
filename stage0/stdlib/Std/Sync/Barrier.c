...
_start:
{
uint8_t v___x_2987__boxed_48_; uint8_t v_res_49_; lean_object* v_r_50_; 
v___x_2987__boxed_48_ = lean_unbox(v___x_45_);
v_res_49_ = l_Std_Barrier_wait___lam__0(v_generationId_44_, v___x_2987__boxed_48_, v___y_46_);
lean_dec(v___y_46_);
