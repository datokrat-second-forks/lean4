...
_start:
{
uint8_t v___x_407__boxed_92_; uint8_t v_res_93_; lean_object* v_r_94_; 
v___x_407__boxed_92_ = lean_unbox(v___x_90_);
v_res_93_ = l_Std_Notify_Consumer_resolve___redArg___lam__0(v___x_407__boxed_92_);
