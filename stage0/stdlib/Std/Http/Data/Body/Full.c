...
_start:
{
uint8_t v___x_178__boxed_373_; lean_object* v_res_374_; 
v___x_178__boxed_373_ = lean_unbox(v___x_370_);
v_res_374_ = l_Std_Http_Body_Full_close___lam__0(v___x_178__boxed_373_, v___y_371_);
lean_dec(v___y_371_);
return v_res_374_;
}
}
