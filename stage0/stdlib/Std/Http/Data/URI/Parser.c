...
v___x_3603_ = lean_nat_dec_eq(v_idx_3599_, v_idx_3602_);
lean_dec(v_idx_3599_);
if (v___x_3603_ == 0)
{
...
v___y_3598_ = v_res_3612_;
v_idx_3599_ = v_idx_3611_;
...
lean_ctor_set(v___x_3699_, 1, v___y_3695_);
