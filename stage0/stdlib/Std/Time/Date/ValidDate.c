...
uint8_t l_Std_Time_Day_instOrdOrdinal___lam__0(lean_object*, lean_object*);
...
{
uint8_t v___x_92_; 
v___x_92_ = l_Std_Time_Day_instOrdOrdinal___lam__0(v_snd_86_, v_snd_88_);
return v___x_92_;
}
}
else
...
LEAN_EXPORT lean_object* l_Std_Time_instOrdValidDate___redArg___lam__0___boxed(lean_object* v_a_94_, lean_object* v_b_95_){
_start:
{
uint8_t v_res_96_; lean_object* v_r_97_; 
v_res_96_ = l_Std_Time_instOrdValidDate___redArg___lam__0(v_a_94_, v_b_95_);
...
v___f_100_ = ((lean_object*)(l_Std_Time_instOrdValidDate___redArg___closed__0));
return v___f_100_;
}
}
LEAN_EXPORT lean_object* l_Std_Time_instOrdValidDate___redArg___boxed(lean_object* v___dummy_101_){
_start:
{
lean_object* v_res_102_; 
v_res_102_ = l_Std_Time_instOrdValidDate___redArg();
return v_res_102_;
}
}
LEAN_EXPORT lean_object* l_Std_Time_instOrdValidDate(uint8_t v_leap_103_){
_start:
{
...
LEAN_EXPORT lean_object* l_Std_Time_instOrdValidDate___boxed(lean_object* v_leap_105_){
_start:
{
uint8_t v_leap_boxed_106_; lean_object* v_res_107_; 
v_leap_boxed_106_ = lean_unbox(v_leap_105_);
v_res_107_ = l_Std_Time_instOrdValidDate(v_leap_boxed_106_);
return v_res_107_;
}
}
LEAN_EXPORT lean_object* l_Std_Time_ValidDate_dayOfYear(uint8_t v_leap_108_, lean_object* v_ordinal_109_){
_start:
{
lean_object* v_fst_110_; lean_object* v_snd_111_; lean_object* v_days_112_; lean_object* v_bounded_113_; 
v_fst_110_ = lean_ctor_get(v_ordinal_109_, 0);
v_snd_111_ = lean_ctor_get(v_ordinal_109_, 1);
v_days_112_ = l_Std_Time_Month_Ordinal_cumulativeDays(v_leap_108_, v_fst_110_);
v_bounded_113_ = lean_int_add(v_days_112_, v_snd_111_);
lean_dec(v_days_112_);
return v_bounded_113_;
}
}
LEAN_EXPORT lean_object* l_Std_Time_ValidDate_dayOfYear___boxed(lean_object* v_leap_114_, lean_object* v_ordinal_115_){
_start:
{
uint8_t v_leap_boxed_116_; lean_object* v_res_117_; 
v_leap_boxed_116_ = lean_unbox(v_leap_114_);
v_res_117_ = l_Std_Time_ValidDate_dayOfYear(v_leap_boxed_116_, v_ordinal_115_);
lean_dec_ref(v_ordinal_115_);
return v_res_117_;
}
}
LEAN_EXPORT lean_object* l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___redArg(uint8_t v_leap_118_, lean_object* v_ordinal_119_, lean_object* v_idx_120_, lean_object* v_acc_121_){
_start:
{
lean_object* v_monthDays_122_; lean_object* v___x_123_; uint8_t v___x_124_; 
v_monthDays_122_ = l_Std_Time_Month_Ordinal_days(v_leap_118_, v_idx_120_);
v___x_123_ = lean_int_add(v_acc_121_, v_monthDays_122_);
lean_dec(v_monthDays_122_);
v___x_124_ = lean_int_dec_le(v_ordinal_119_, v___x_123_);
if (v___x_124_ == 0)
{
lean_object* v___x_125_; lean_object* v_idx_u2082_126_; 
lean_dec(v_acc_121_);
v___x_125_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__0, &l_Std_Time_instInhabitedValidDate___redArg___closed__0_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__0);
v_idx_u2082_126_ = lean_int_add(v_idx_120_, v___x_125_);
lean_dec(v_idx_120_);
v_idx_120_ = v_idx_u2082_126_;
v_acc_121_ = v___x_123_;
goto _start;
}
else
{
lean_object* v___x_128_; lean_object* v_days_u2081_129_; lean_object* v___x_130_; 
lean_dec(v___x_123_);
v___x_128_ = lean_int_neg(v_acc_121_);
lean_dec(v_acc_121_);
v_days_u2081_129_ = lean_int_add(v_ordinal_119_, v___x_128_);
lean_dec(v___x_128_);
v___x_130_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_130_, 0, v_idx_120_);
lean_ctor_set(v___x_130_, 1, v_days_u2081_129_);
return v___x_130_;
}
}
}
LEAN_EXPORT lean_object* l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___redArg___boxed(lean_object* v_leap_131_, lean_object* v_ordinal_132_, lean_object* v_idx_133_, lean_object* v_acc_134_){
_start:
{
uint8_t v_leap_boxed_135_; lean_object* v_res_136_; 
v_leap_boxed_135_ = lean_unbox(v_leap_131_);
v_res_136_ = l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___redArg(v_leap_boxed_135_, v_ordinal_132_, v_idx_133_, v_acc_134_);
lean_dec(v_ordinal_132_);
return v_res_136_;
}
}
LEAN_EXPORT lean_object* l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go(uint8_t v_leap_137_, lean_object* v_ordinal_138_, lean_object* v_idx_139_, lean_object* v_acc_140_, lean_object* v_h_141_, lean_object* v_p_142_){
_start:
{
lean_object* v___x_143_; 
v___x_143_ = l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___redArg(v_leap_137_, v_ordinal_138_, v_idx_139_, v_acc_140_);
return v___x_143_;
}
}
LEAN_EXPORT lean_object* l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___boxed(lean_object* v_leap_144_, lean_object* v_ordinal_145_, lean_object* v_idx_146_, lean_object* v_acc_147_, lean_object* v_h_148_, lean_object* v_p_149_){
_start:
{
uint8_t v_leap_boxed_150_; lean_object* v_res_151_; 
v_leap_boxed_150_ = lean_unbox(v_leap_144_);
v_res_151_ = l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go(v_leap_boxed_150_, v_ordinal_145_, v_idx_146_, v_acc_147_, v_h_148_, v_p_149_);
...
v___x_154_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__0, &l_Std_Time_ValidDate_ofOrdinal___closed__0_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__0);
v___x_155_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__0, &l_Std_Time_instInhabitedValidDate___redArg___closed__0_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__0);
...
v___x_157_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__0, &l_Std_Time_instInhabitedValidDate___redArg___closed__0_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__0);
v___x_158_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__1, &l_Std_Time_ValidDate_ofOrdinal___closed__1_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__1);
...
v___x_160_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__0, &l_Std_Time_instInhabitedValidDate___redArg___closed__0_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__0);
v___x_161_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__2, &l_Std_Time_ValidDate_ofOrdinal___closed__2_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__2);
...
v_range_163_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__3, &l_Std_Time_ValidDate_ofOrdinal___closed__3_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__3);
v___x_164_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__5, &l_Std_Time_instInhabitedValidDate___redArg___closed__5_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__5);
...
_start:
{
lean_object* v_range_166_; lean_object* v___x_167_; lean_object* v___x_168_; 
v_range_166_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__3, &l_Std_Time_ValidDate_ofOrdinal___closed__3_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__3);
v___x_167_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__4, &l_Std_Time_ValidDate_ofOrdinal___closed__4_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__4);
v___x_168_ = lean_int_add(v___x_167_, v_range_166_);
return v___x_168_;
}
}
...
_start:
{
lean_object* v_range_169_; lean_object* v___x_170_; lean_object* v___x_171_; 
v_range_169_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__3, &l_Std_Time_ValidDate_ofOrdinal___closed__3_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__3);
v___x_170_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__5, &l_Std_Time_ValidDate_ofOrdinal___closed__5_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__5);
...
v___x_172_ = lean_obj_once(&l_Std_Time_instInhabitedValidDate___redArg___closed__0, &l_Std_Time_instInhabitedValidDate___redArg___closed__0_once, _init_l_Std_Time_instInhabitedValidDate___redArg___closed__0);
v___x_173_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__6, &l_Std_Time_ValidDate_ofOrdinal___closed__6_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__6);
v___x_174_ = lean_int_add(v___x_173_, v___x_172_);
return v___x_174_;
}
}
...
LEAN_EXPORT lean_object* l_Std_Time_ValidDate_ofOrdinal(uint8_t v_leap_177_, lean_object* v_ordinal_178_){
_start:
{
lean_object* v___x_179_; lean_object* v___x_180_; lean_object* v___x_181_; 
v___x_179_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__7, &l_Std_Time_ValidDate_ofOrdinal___closed__7_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__7);
v___x_180_ = lean_obj_once(&l_Std_Time_ValidDate_ofOrdinal___closed__8, &l_Std_Time_ValidDate_ofOrdinal___closed__8_once, _init_l_Std_Time_ValidDate_ofOrdinal___closed__8);
v___x_181_ = l___private_Std_Time_Date_ValidDate_0__Std_Time_ValidDate_ofOrdinal_go___redArg(v_leap_177_, v_ordinal_178_, v___x_179_, v___x_180_);
return v___x_181_;
}
}
LEAN_EXPORT lean_object* l_Std_Time_ValidDate_ofOrdinal___boxed(lean_object* v_leap_182_, lean_object* v_ordinal_183_){
_start:
{
uint8_t v_leap_boxed_184_; lean_object* v_res_185_; 
v_leap_boxed_184_ = lean_unbox(v_leap_182_);
v_res_185_ = l_Std_Time_ValidDate_ofOrdinal(v_leap_boxed_184_, v_ordinal_183_);
lean_dec(v_ordinal_183_);
return v_res_185_;
}
}
