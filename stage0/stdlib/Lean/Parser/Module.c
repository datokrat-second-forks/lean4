...
v___x_484_ = l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Parser_parseHeader_spec__2(v_inputCtx_420_, v___y_477_, v___x_482_, v_sz_483_, v___y_478_, v___y_479_);
...
v___x_508_ = l_Lean_Name_mkStr4(v___y_495_, v___y_497_, v___y_499_, v___x_507_);
