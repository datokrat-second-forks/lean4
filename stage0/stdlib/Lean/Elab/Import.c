...
v_val_646_ = lean_ctor_get(v___y_640_, 0);
lean_inc(v_val_646_);
...
v___x_673_ = l_Lean_Syntax_getArg(v___y_669_, v___x_672_);
...
v___x_678_ = l_Lean_Name_mkStr4(v___y_666_, v___y_667_, v___y_668_, v___x_677_);
