...
lean_ctor_set_uint8(v___x_987_, sizeof(void*)*5 + 1, v___y_976_);
...
v___x_1026_ = l_Lean_FileMap_toPosition(v___y_1016_, v___y_1013_);
...
v___x_1047_ = l_Lean_Syntax_getTailPos_x3f(v___y_1040_, v___y_1044_);
