...
lean_inc(v___y_3212_);
lean_inc_ref(v___y_3211_);
v_r_3252_ = lean_apply_5(v_x_3209_, v___y_3211_, v___y_3212_, v___y_3213_, v___y_3214_, lean_box(0));
