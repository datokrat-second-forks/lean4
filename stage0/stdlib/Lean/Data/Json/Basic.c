...
v___x_260_ = lean_nat_add(v___y_257_, v___y_255_);
lean_dec(v___y_255_);
lean_dec(v___y_257_);
...
v___x_244_ = lean_string_append(v___y_241_, v___y_242_);
...
lean_ctor_set(v___x_1641_, 3, v___y_1659_);
...
lean_ctor_set(v_reuseFailAlloc_1667_, 3, v___y_1659_);
