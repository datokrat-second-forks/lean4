...
_start:
{
uint8_t v___x_374__boxed_53_; lean_object* v_res_54_; 
v___x_374__boxed_53_ = lean_unbox(v___x_50_);
v_res_54_ = l_Lean_withImporting___redArg___lam__0(v___x_49_, v___x_374__boxed_53_, v_x_51_);
lean_dec(v_x_51_);
lean_dec(v___x_49_);
return v_res_54_;
}
