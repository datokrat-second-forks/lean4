...
_start:
{
uint8_t v_x_6279__boxed_661_; lean_object* v_res_662_; 
v_x_6279__boxed_661_ = lean_unbox(v_x_657_);
v_res_662_ = l_Lean_ParserCompiler_registerCombinatorAttribute___lam__3(v_a_654_, v_decl_655_, v_stx_656_, v_x_6279__boxed_661_, v___y_658_, v___y_659_);
lean_dec(v___y_659_);
