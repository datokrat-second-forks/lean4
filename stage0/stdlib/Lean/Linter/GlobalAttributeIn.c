...
_start:
{
uint8_t v_suppressElabErrors_boxed_312_; uint8_t v___y_4769__boxed_313_; uint8_t v_res_314_; lean_object* v_r_315_; 
v_suppressElabErrors_boxed_312_ = lean_unbox(v_suppressElabErrors_309_);
v___y_4769__boxed_313_ = lean_unbox(v___y_310_);
v_res_314_ = l_Lean_logAt___at___00Lean_logErrorAt___at___00__private_Lean_Linter_GlobalAttributeIn_0__Lean_Linter_globalAttributeIn_spec__0_spec__0___lam__0(v_suppressElabErrors_boxed_312_, v___y_4769__boxed_313_, v_x_311_);
lean_dec(v_x_311_);
