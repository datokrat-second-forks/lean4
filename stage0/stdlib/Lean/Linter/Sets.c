...
LEAN_EXPORT lean_object* l_Lean_Linter_registerSet___boxed(lean_object* v_setName_128_, lean_object* v_ref_129_, lean_object* v___y_130_){
_start:
{
...
LEAN_EXPORT lean_object* l_Lean_Linter___aux__Lean__Linter__Sets______elabRules__Lean__Linter__command__Register__linter__set___x3a_x3d____1(lean_object* v_x_372_, lean_object* v___y_373_, lean_object* v___y_374_){
_start:
{
...
v___x_430_ = l_Array_append___redArg(v___y_421_, v___y_429_);
lean_dec_ref(v___y_429_);
lean_inc_n(v___y_428_, 5);
lean_inc_n(v___y_419_, 17);
v___x_431_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_431_, 0, v___y_419_);
lean_ctor_set(v___x_431_, 1, v___y_428_);
lean_ctor_set(v___x_431_, 2, v___x_430_);
v___x_432_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_432_, 0, v___y_419_);
lean_ctor_set(v___x_432_, 1, v___y_428_);
lean_ctor_set(v___x_432_, 2, v___y_421_);
...
v___x_434_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___y_426_, v___x_433_);
v___x_435_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_435_, 0, v___y_419_);
lean_ctor_set(v___x_435_, 1, v___x_433_);
v___x_436_ = l_Lean_Syntax_node1(v___y_419_, v___x_434_, v___x_435_);
v___x_437_ = l_Lean_Syntax_node1(v___y_419_, v___y_428_, v___x_436_);
lean_inc_ref_n(v___x_432_, 5);
lean_inc(v___y_425_);
v___x_438_ = l_Lean_Syntax_node7(v___y_419_, v___y_425_, v___x_431_, v___x_432_, v___x_432_, v___x_432_, v___x_437_, v___x_432_, v___x_432_);
...
v___x_440_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___y_426_, v___x_439_);
lean_inc_ref(v___y_423_);
v___x_441_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_441_, 0, v___y_419_);
lean_ctor_set(v___x_441_, 1, v___y_423_);
v___x_442_ = l_Lean_Syntax_node1(v___y_419_, v___x_440_, v___x_441_);
...
v___x_445_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_444_);
...
lean_ctor_set(v___x_447_, 0, v___y_419_);
...
v___x_449_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_448_);
...
v___x_452_ = l_Lean_addMacroScope(v___y_418_, v___x_451_, v___y_422_);
...
lean_ctor_set(v___x_455_, 0, v___y_419_);
...
v___x_458_ = l_Lean_addMacroScope(v___y_418_, v___x_457_, v___y_422_);
...
lean_ctor_set(v___x_460_, 0, v___y_419_);
lean_ctor_set(v___x_460_, 1, v___x_456_);
lean_ctor_set(v___x_460_, 2, v___x_458_);
lean_ctor_set(v___x_460_, 3, v___x_459_);
v___x_461_ = l_Lean_Syntax_node1(v___y_419_, v___y_428_, v___x_460_);
lean_inc(v___x_449_);
v___x_462_ = l_Lean_Syntax_node2(v___y_419_, v___x_449_, v___x_455_, v___x_461_);
v___x_463_ = l_Lean_Syntax_node2(v___y_419_, v___x_445_, v___x_447_, v___x_462_);
...
lean_ctor_set(v___x_465_, 0, v___y_419_);
lean_ctor_set(v___x_465_, 1, v___x_464_);
v___x_466_ = l_Lean_Syntax_node3(v___y_419_, v___y_428_, v_name_416_, v___x_463_, v___x_465_);
...
v___x_468_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_467_);
...
v___x_470_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_469_);
...
v___x_472_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_471_);
...
v___x_475_ = l_Lean_addMacroScope(v___y_418_, v___x_474_, v___y_422_);
...
lean_ctor_set(v___x_477_, 0, v___y_419_);
lean_ctor_set(v___x_477_, 1, v___x_473_);
lean_ctor_set(v___x_477_, 2, v___x_475_);
lean_ctor_set(v___x_477_, 3, v___x_476_);
lean_inc(v___y_424_);
v___x_478_ = l___private_Init_Meta_Defs_0__Lean_getEscapedNameParts_x3f(v___x_453_, v___y_424_);
if (lean_obj_tag(v___x_478_) == 0)
{
lean_object* v___x_479_; 
v___x_479_ = l_Lean_quoteNameMk(v___y_424_);
v___y_377_ = v___y_419_;
v___y_378_ = v___x_468_;
v___y_379_ = v___x_449_;
v___y_380_ = v___y_427_;
v___y_381_ = v___x_442_;
v___y_382_ = v___x_470_;
v___y_383_ = v___x_472_;
v___y_384_ = v___x_432_;
v___y_385_ = v___x_438_;
v___y_386_ = v___x_477_;
...
v___x_482_ = l_Lean_Name_mkStr4(v___x_409_, v___y_420_, v___x_443_, v___x_481_);
...
v_val_506_ = lean_ctor_get(v___y_495_, 0);
lean_inc(v_val_506_);
...
lean_inc(v___y_511_);
v___x_513_ = l_Lean_Linter_insertLinterSet___at___00Lean_Linter___aux__Lean__Linter__Sets______elabRules__Lean__Linter__command__Register__linter__set___x3a_x3d____1_spec__1___redArg(v___y_511_, v___y_512_, v___y_374_);
lean_dec_ref(v___x_513_);
v___x_514_ = l_Lean_Elab_Command_getRef___redArg(v___y_373_);
...
lean_dec(v_a_515_);
v___x_518_ = l_Lean_Elab_Command_getCurrMacroScope___redArg(v___y_373_);
if (lean_obj_tag(v___x_518_) == 0)
{
lean_object* v_quotContext_x3f_519_; 
v_quotContext_x3f_519_ = lean_ctor_get(v___y_373_, 5);
...
v___x_521_ = l_Lean_getMainModule___at___00Lean_Linter___aux__Lean__Linter__Sets______elabRules__Lean__Linter__command__Register__linter__set___x3a_x3d____1_spec__2___redArg(v___y_374_);
...
lean_inc_n(v___y_377_, 6);
v___x_390_ = l_Lean_Syntax_node1(v___y_377_, v___y_387_, v___y_389_);
v___x_391_ = l_Lean_Syntax_node2(v___y_377_, v___y_379_, v___y_386_, v___x_390_);
v___x_392_ = l_Lean_Syntax_node1(v___y_377_, v___y_383_, v___x_391_);
v___x_393_ = l_Lean_Syntax_node2(v___y_377_, v___y_382_, v___x_392_, v___y_384_);
v___x_394_ = l_Lean_Syntax_node1(v___y_377_, v___y_387_, v___x_393_);
v___x_395_ = l_Lean_Syntax_node1(v___y_377_, v___y_378_, v___x_394_);
lean_inc(v___y_380_);
v___x_396_ = l_Lean_Syntax_node4(v___y_377_, v___y_380_, v___y_385_, v___y_381_, v___y_388_, v___x_395_);
v___x_397_ = l_Lean_Elab_Command_getRef___redArg(v___y_373_);
...
v___x_400_ = l_Lean_Elab_Command_withMacroExpansion___redArg(v_a_398_, v___x_396_, v___x_399_, v___y_373_, v___y_374_);
return v___x_400_;
}
else
{
...
LEAN_EXPORT lean_object* l_Lean_Linter___aux__Lean__Linter__Sets______elabRules__Lean__Linter__command__Register__linter__set___x3a_x3d____1___boxed(lean_object* v_x_567_, lean_object* v___y_568_, lean_object* v___y_569_, lean_object* v___y_570_){
_start:
{
lean_object* v_res_571_; 
v_res_571_ = l_Lean_Linter___aux__Lean__Linter__Sets______elabRules__Lean__Linter__command__Register__linter__set___x3a_x3d____1(v_x_567_, v___y_568_, v___y_569_);
lean_dec(v___y_569_);
