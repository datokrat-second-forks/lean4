...
_start:
{
uint8_t v_suppressElabErrors_boxed_135_; uint8_t v___y_3498__boxed_136_; uint8_t v_res_137_; lean_object* v_r_138_; 
v_suppressElabErrors_boxed_135_ = lean_unbox(v_suppressElabErrors_132_);
v___y_3498__boxed_136_ = lean_unbox(v___y_133_);
v_res_137_ = l_Lean_logAt___at___00Lean_logWarningAt___at___00Lean_Linter_logLint___at___00Lean_Linter_omit_spec__1_spec__2_spec__3___lam__0(v_suppressElabErrors_boxed_135_, v___y_3498__boxed_136_, v_x_134_);
lean_dec(v_x_134_);
...
v___x_246_ = l_Lean_Syntax_getTailPos_x3f(v___y_243_, v___y_244_);
lean_dec(v___y_243_);
