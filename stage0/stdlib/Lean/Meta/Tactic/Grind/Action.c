...
v___x_2099_ = l_Lean_FileMap_toPosition(v___y_2091_, v___y_2090_);
...
v___x_2120_ = l_Lean_Syntax_getTailPos_x3f(v___y_2115_, v___y_2113_);
...
v___y_2140_ = v_openDecls_2156_;
v___y_2141_ = v_fileMap_2153_;
