...
_start:
{
lean_object* v___x_80_; lean_object* v___x_447__overap_81_; lean_object* v___x_82_; 
...
v___x_447__overap_81_ = lean_panic_fn_borrowed(v___x_80_, v_msg_76_);
lean_inc(v___y_78_);
lean_inc_ref(v___y_77_);
v___x_82_ = lean_apply_3(v___x_447__overap_81_, v___y_77_, v___y_78_, lean_box(0));
return v___x_82_;
}
}
