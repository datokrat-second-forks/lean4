...
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Cbv__simproc__decl___x28___x29_x3a_x3d____1(lean_object* v_x_395_, lean_object* v_a_396_, lean_object* v___y_397_){
_start:
{
...
lean_ctor_set(v___x_484_, 1, v___y_397_);
return v___x_484_;
}
else
{
...
lean_ctor_set(v___x_491_, 1, v___y_397_);
return v___x_491_;
}
else
{
...
lean_ctor_set(v___x_498_, 1, v___y_397_);
return v___x_498_;
}
else
{
...
lean_inc_ref_n(v___y_411_, 2);
v___x_413_ = l_Array_append___redArg(v___y_411_, v___y_412_);
...
lean_ctor_set(v___x_415_, 2, v___y_411_);
...
v___x_420_ = l_Lean_Syntax_node1(v___y_410_, v___y_402_, v___x_419_);
lean_inc_ref_n(v___x_415_, 10);
lean_inc(v___y_409_);
v___x_421_ = l_Lean_Syntax_node7(v___y_410_, v___y_409_, v___x_414_, v___x_415_, v___x_415_, v___x_415_, v___x_420_, v___x_415_, v___x_415_);
...
lean_inc(v___y_405_);
v___x_428_ = l_Lean_Syntax_node2(v___y_410_, v___x_427_, v___y_405_, v___x_415_);
...
v___x_436_ = l_Lean_Syntax_node1(v___y_410_, v___y_402_, v___x_435_);
...
v___x_444_ = l_Lean_Syntax_node4(v___y_410_, v___x_439_, v___x_441_, v___y_404_, v___x_443_, v___x_415_);
v___x_445_ = l_Lean_Syntax_node5(v___y_410_, v___x_423_, v___x_425_, v___x_428_, v___x_437_, v___x_444_, v___x_415_);
lean_inc(v___y_406_);
v___x_446_ = l_Lean_Syntax_node2(v___y_410_, v___y_406_, v___x_421_, v___x_445_);
...
v___x_452_ = l_Lean_Syntax_node4(v___y_410_, v___x_447_, v___x_449_, v___y_408_, v___x_451_, v___y_405_);
v___x_453_ = l_Lean_Syntax_node2(v___y_410_, v___y_402_, v___x_446_, v___x_452_);
...
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Cbv__simproc__decl___x28___x29_x3a_x3d____1___boxed(lean_object* v_x_500_, lean_object* v_a_501_, lean_object* v___y_502_){
_start:
{
lean_object* v_res_503_; 
v_res_503_ = l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Cbv__simproc__decl___x28___x29_x3a_x3d____1(v_x_500_, v_a_501_, v___y_502_);
lean_dec_ref(v_a_501_);
return v_res_503_;
}
}
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Builtin__cbv__simproc__decl___x28___x29_x3a_x3d____1(lean_object* v_x_505_, lean_object* v_a_506_, lean_object* v___y_507_){
_start:
{
...
lean_ctor_set(v___x_589_, 1, v___y_507_);
return v___x_589_;
}
else
{
...
lean_ctor_set(v___x_596_, 1, v___y_507_);
return v___x_596_;
}
else
{
...
lean_ctor_set(v___x_603_, 1, v___y_507_);
return v___x_603_;
}
else
{
...
v___x_523_ = l_Array_append___redArg(v___y_518_, v___y_522_);
lean_dec_ref(v___y_522_);
lean_inc_n(v___y_517_, 4);
lean_inc_n(v___y_511_, 17);
v___x_524_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_524_, 0, v___y_511_);
lean_ctor_set(v___x_524_, 1, v___y_517_);
lean_ctor_set(v___x_524_, 2, v___x_523_);
v___x_525_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_525_, 0, v___y_511_);
lean_ctor_set(v___x_525_, 1, v___y_517_);
lean_ctor_set(v___x_525_, 2, v___y_518_);
lean_inc_ref_n(v___x_525_, 11);
lean_inc(v___y_520_);
v___x_526_ = l_Lean_Syntax_node7(v___y_511_, v___y_520_, v___x_524_, v___x_525_, v___x_525_, v___x_525_, v___x_525_, v___x_525_, v___x_525_);
...
lean_inc_ref_n(v___y_521_, 4);
v___x_528_ = l_Lean_Name_mkStr4(v___x_508_, v___x_509_, v___y_521_, v___x_527_);
...
v___x_532_ = l_Lean_Name_mkStr4(v___x_508_, v___x_509_, v___y_521_, v___x_531_);
lean_inc(v___y_513_);
v___x_533_ = l_Lean_Syntax_node2(v___y_511_, v___x_532_, v___y_513_, v___x_525_);
...
v___x_535_ = l_Lean_Name_mkStr4(v___x_508_, v___x_509_, v___y_521_, v___x_534_);
...
lean_inc(v___y_516_);
v___x_539_ = l_Lean_mkIdent(v___y_516_);
v___x_540_ = l_Lean_Syntax_node2(v___y_511_, v___x_536_, v___x_538_, v___x_539_);
v___x_541_ = l_Lean_Syntax_node1(v___y_511_, v___y_517_, v___x_540_);
v___x_542_ = l_Lean_Syntax_node2(v___y_511_, v___x_535_, v___x_525_, v___x_541_);
...
v___x_544_ = l_Lean_Name_mkStr4(v___x_508_, v___x_509_, v___y_521_, v___x_543_);
...
v___x_548_ = l_Lean_Syntax_node2(v___y_511_, v___x_547_, v___x_525_, v___x_525_);
v___x_549_ = l_Lean_Syntax_node4(v___y_511_, v___x_544_, v___x_546_, v___y_519_, v___x_548_, v___x_525_);
v___x_550_ = l_Lean_Syntax_node5(v___y_511_, v___x_528_, v___x_530_, v___x_533_, v___x_542_, v___x_549_, v___x_525_);
lean_inc(v___y_515_);
v___x_551_ = l_Lean_Syntax_node2(v___y_511_, v___y_515_, v___x_526_, v___x_550_);
...
v___x_557_ = l_Lean_Syntax_node4(v___y_511_, v___x_552_, v___x_554_, v___y_512_, v___x_556_, v___y_513_);
v___x_558_ = l_Lean_Syntax_node2(v___y_511_, v___y_517_, v___x_551_, v___x_557_);
v___x_559_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_559_, 0, v___x_558_);
lean_ctor_set(v___x_559_, 1, v___y_514_);
return v___x_559_;
}
v___jp_560_:
{
...
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Builtin__cbv__simproc__decl___x28___x29_x3a_x3d____1___boxed(lean_object* v_x_605_, lean_object* v_a_606_, lean_object* v___y_607_){
_start:
{
lean_object* v_res_608_; 
v_res_608_ = l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command__Builtin__cbv__simproc__decl___x28___x29_x3a_x3d____1(v_x_605_, v_a_606_, v___y_607_);
lean_dec_ref(v_a_606_);
return v_res_608_;
}
}
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Cbv__simproc_________x28___x29_x3a_x3d____1(lean_object* v_x_625_, lean_object* v_a_626_, lean_object* v___y_627_){
_start:
{
...
lean_ctor_set(v___x_659_, 1, v___y_627_);
return v___x_659_;
}
else
{
...
lean_ctor_set(v___x_748_, 1, v___y_627_);
return v___x_748_;
}
else
{
...
lean_ctor_set(v___x_755_, 1, v___y_627_);
return v___x_755_;
}
else
{
...
lean_ctor_set(v___x_683_, 0, v___y_669_);
lean_ctor_set(v___x_683_, 1, v___x_682_);
lean_inc(v___y_665_);
lean_inc(v___y_671_);
v___x_684_ = l_Lean_Syntax_node8(v___y_669_, v___y_671_, v___x_675_, v___x_677_, v___y_665_, v___x_679_, v___y_663_, v___x_681_, v___x_683_, v___y_664_);
...
lean_ctor_set(v___x_689_, 0, v___y_669_);
...
v___x_691_ = l_Lean_Name_mkStr4(v___x_654_, v___x_655_, v___y_670_, v___x_690_);
...
v___y_634_ = v___y_668_;
v___y_635_ = v___x_687_;
v___y_636_ = v___x_684_;
v___y_637_ = v___x_694_;
v___y_638_ = v___x_689_;
...
v___y_662_ = v_phase_x3f_701_;
v___y_663_ = v___x_712_;
v___y_664_ = v___x_714_;
v___y_665_ = v___x_705_;
v___y_666_ = v___x_718_;
v___y_667_ = v___x_720_;
v___y_668_ = v___y_703_;
v___y_669_ = v___x_717_;
v___y_670_ = v___x_715_;
v___y_671_ = v___x_719_;
...
lean_ctor_set(v___x_644_, 1, v___y_630_);
lean_ctor_set(v___x_644_, 2, v___x_643_);
lean_inc(v___y_629_);
v___x_645_ = l_Lean_Syntax_node2(v___y_639_, v___y_629_, v___y_637_, v___x_644_);
v___x_646_ = l_Lean_Syntax_node2(v___y_639_, v___y_633_, v___y_640_, v___x_645_);
v___x_647_ = l_Lean_Syntax_node1(v___y_639_, v___y_630_, v___x_646_);
...
lean_ctor_set(v___x_649_, 0, v___y_639_);
lean_ctor_set(v___x_649_, 1, v___x_648_);
v___x_650_ = l_Lean_Syntax_node1(v___y_639_, v___y_630_, v___y_631_);
lean_inc(v___y_641_);
v___x_651_ = l_Lean_Syntax_node5(v___y_639_, v___y_641_, v___y_635_, v___y_638_, v___x_647_, v___x_649_, v___x_650_);
v___x_652_ = l_Lean_Syntax_node2(v___y_639_, v___y_630_, v___y_636_, v___x_651_);
v___x_653_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_653_, 0, v___x_652_);
lean_ctor_set(v___x_653_, 1, v___y_634_);
return v___x_653_;
}
}
}
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Cbv__simproc_________x28___x29_x3a_x3d____1___boxed(lean_object* v_x_757_, lean_object* v_a_758_, lean_object* v___y_759_){
_start:
{
lean_object* v_res_760_; 
v_res_760_ = l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Cbv__simproc_________x28___x29_x3a_x3d____1(v_x_757_, v_a_758_, v___y_759_);
lean_dec_ref(v_a_758_);
return v_res_760_;
}
}
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Builtin__cbv__simproc_________x28___x29_x3a_x3d____1(lean_object* v_x_762_, lean_object* v_a_763_, lean_object* v___y_764_){
_start:
{
...
lean_ctor_set(v___x_796_, 1, v___y_764_);
return v___x_796_;
}
else
{
...
lean_ctor_set(v___x_885_, 1, v___y_764_);
return v___x_885_;
}
else
{
...
lean_ctor_set(v___x_892_, 1, v___y_764_);
return v___x_892_;
}
else
{
...
v___x_811_ = l_Array_append___redArg(v___y_800_, v___y_810_);
lean_dec_ref(v___y_810_);
lean_inc(v___y_802_);
lean_inc_n(v___y_799_, 9);
v___x_812_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_812_, 0, v___y_799_);
lean_ctor_set(v___x_812_, 1, v___y_802_);
...
lean_ctor_set(v___x_814_, 0, v___y_799_);
...
lean_ctor_set(v___x_816_, 0, v___y_799_);
...
lean_ctor_set(v___x_818_, 0, v___y_799_);
...
lean_ctor_set(v___x_820_, 0, v___y_799_);
lean_ctor_set(v___x_820_, 1, v___x_819_);
lean_inc(v___y_804_);
lean_inc(v___y_805_);
v___x_821_ = l_Lean_Syntax_node8(v___y_799_, v___y_805_, v___x_812_, v___x_814_, v___y_804_, v___x_816_, v___y_803_, v___x_818_, v___x_820_, v___y_807_);
...
lean_ctor_set(v___x_824_, 0, v___y_799_);
...
lean_ctor_set(v___x_826_, 0, v___y_799_);
...
v___x_828_ = l_Lean_Name_mkStr4(v___x_791_, v___x_792_, v___y_809_, v___x_827_);
...
v___x_780_ = l_Array_append___redArg(v___y_772_, v___y_779_);
lean_dec_ref(v___y_779_);
lean_inc_n(v___y_773_, 4);
lean_inc_n(v___y_767_, 7);
v___x_781_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_781_, 0, v___y_767_);
lean_ctor_set(v___x_781_, 1, v___y_773_);
lean_ctor_set(v___x_781_, 2, v___x_780_);
lean_inc(v___y_768_);
v___x_782_ = l_Lean_Syntax_node2(v___y_767_, v___y_768_, v___y_770_, v___x_781_);
v___x_783_ = l_Lean_Syntax_node2(v___y_767_, v___y_766_, v___y_774_, v___x_782_);
v___x_784_ = l_Lean_Syntax_node1(v___y_767_, v___y_773_, v___x_783_);
...
lean_ctor_set(v___x_786_, 0, v___y_767_);
lean_ctor_set(v___x_786_, 1, v___x_785_);
v___x_787_ = l_Lean_Syntax_node1(v___y_767_, v___y_773_, v___y_775_);
lean_inc(v___y_771_);
v___x_788_ = l_Lean_Syntax_node5(v___y_767_, v___y_771_, v___y_769_, v___y_776_, v___x_784_, v___x_786_, v___x_787_);
v___x_789_ = l_Lean_Syntax_node2(v___y_767_, v___y_773_, v___y_778_, v___x_788_);
v___x_790_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_790_, 0, v___x_789_);
lean_ctor_set(v___x_790_, 1, v___y_777_);
return v___x_790_;
}
}
}
LEAN_EXPORT lean_object* l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Builtin__cbv__simproc_________x28___x29_x3a_x3d____1___boxed(lean_object* v_x_894_, lean_object* v_a_895_, lean_object* v___y_896_){
_start:
{
lean_object* v_res_897_; 
v_res_897_ = l_Lean_Parser___aux__Init__CbvSimproc______macroRules__Lean__Parser__command____Builtin__cbv__simproc_________x28___x29_x3a_x3d____1(v_x_894_, v_a_895_, v___y_896_);
