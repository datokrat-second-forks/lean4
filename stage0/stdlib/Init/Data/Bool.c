...
LEAN_EXPORT lean_object* l_Bool___aux__Init__Data__Bool______macroRules__Bool__term___x5e_x5e____1(lean_object* v_x_62_, lean_object* v___y_63_, lean_object* v___y_64_){
_start:
{
...
lean_ctor_set(v___x_68_, 1, v___y_64_);
return v___x_68_;
}
else
{
...
v_quotContext_69_ = lean_ctor_get(v___y_63_, 1);
v_currMacroScope_70_ = lean_ctor_get(v___y_63_, 2);
v_ref_71_ = lean_ctor_get(v___y_63_, 5);
...
lean_ctor_set(v___x_87_, 1, v___y_64_);
return v___x_87_;
}
}
}
LEAN_EXPORT lean_object* l_Bool___aux__Init__Data__Bool______macroRules__Bool__term___x5e_x5e____1___boxed(lean_object* v_x_88_, lean_object* v___y_89_, lean_object* v___y_90_){
_start:
{
lean_object* v_res_91_; 
v_res_91_ = l_Bool___aux__Init__Data__Bool______macroRules__Bool__term___x5e_x5e____1(v_x_88_, v___y_89_, v___y_90_);
lean_dec_ref(v___y_89_);
return v_res_91_;
}
}
LEAN_EXPORT lean_object* l_Bool___aux__Init__Data__Bool______unexpand__Bool__xor__1(lean_object* v_x_95_, lean_object* v___y_96_, lean_object* v___y_97_){
_start:
{
...
lean_ctor_set(v___x_113_, 1, v___y_97_);
return v___x_113_;
}
else
{
...
lean_dec(v___x_109_);
v_ref_116_ = l_Lean_replaceRef(v___x_103_, v___y_96_);
lean_dec(v___x_103_);
v___x_117_ = 0;
...
lean_ctor_set(v___x_123_, 1, v___y_97_);
return v___x_123_;
}
}
}
...
LEAN_EXPORT lean_object* l_Bool___aux__Init__Data__Bool______unexpand__Bool__xor__1___boxed(lean_object* v_x_124_, lean_object* v___y_125_, lean_object* v___y_126_){
_start:
{
lean_object* v_res_127_; 
v_res_127_ = l_Bool___aux__Init__Data__Bool______unexpand__Bool__xor__1(v_x_124_, v___y_125_, v___y_126_);
lean_dec(v___y_125_);
return v_res_127_;
}
}
...
LEAN_EXPORT lean_object* l_boolPredToPred___redArg___boxed(lean_object* v___dummy_224_){
_start:
{
lean_object* v_res_225_; 
v_res_225_ = l_boolPredToPred___redArg();
return v_res_225_;
}
}
LEAN_EXPORT lean_object* l_boolPredToPred(lean_object* v_00_u03b1_226_){
_start:
{
...
LEAN_EXPORT lean_object* l_boolRelToRel___redArg___boxed(lean_object* v___dummy_230_){
_start:
{
lean_object* v_res_231_; 
v_res_231_ = l_boolRelToRel___redArg();
return v_res_231_;
}
}
LEAN_EXPORT lean_object* l_boolRelToRel(lean_object* v_00_u03b1_232_){
_start:
{
...
LEAN_EXPORT uint8_t l_Bool_and_x27(uint8_t v_a_234_, uint8_t v_b_235_){
_start:
{
if (v_a_234_ == 0)
{
...
LEAN_EXPORT lean_object* l_Bool_and_x27___boxed(lean_object* v_a_236_, lean_object* v_b_237_){
_start:
{
...
v_res_240_ = l_Bool_and_x27(v_a_boxed_238_, v_b_boxed_239_);
v_r_241_ = lean_box(v_res_240_);
return v_r_241_;
}
}
LEAN_EXPORT uint8_t l_Bool_or_x27(uint8_t v_a_242_, uint8_t v_b_243_){
_start:
{
if (v_a_242_ == 0)
{
...
LEAN_EXPORT lean_object* l_Bool_or_x27___boxed(lean_object* v_a_244_, lean_object* v_b_245_){
_start:
{
uint8_t v_a_boxed_246_; uint8_t v_b_boxed_247_; uint8_t v_res_248_; lean_object* v_r_249_; 
v_a_boxed_246_ = lean_unbox(v_a_244_);
v_b_boxed_247_ = lean_unbox(v_b_245_);
v_res_248_ = l_Bool_or_x27(v_a_boxed_246_, v_b_boxed_247_);
v_r_249_ = lean_box(v_res_248_);
return v_r_249_;
}
}
LEAN_EXPORT uint8_t l_Bool_not_x27(uint8_t v_a_250_){
_start:
{
if (v_a_250_ == 0)
{
...
LEAN_EXPORT lean_object* l_Bool_not_x27___boxed(lean_object* v_a_253_){
_start:
{
uint8_t v_a_boxed_254_; uint8_t v_res_255_; lean_object* v_r_256_; 
v_a_boxed_254_ = lean_unbox(v_a_253_);
v_res_255_ = l_Bool_not_x27(v_a_boxed_254_);
