...
LEAN_EXPORT lean_object* l_Lake_OpaqueTargetConfig_nonemptyType___redArg();
LEAN_EXPORT lean_object* l_Lake_OpaqueTargetConfig_nonemptyType___redArg___boxed(lean_object*);
...
static lean_object* _init_l_Lake_OpaqueWorkspace_nonemptyType(void){
_start:
{
...
LEAN_EXPORT lean_object* l_Lake_OpaqueTargetConfig_nonemptyType___redArg___boxed(lean_object* v___dummy_4_){
_start:
{
lean_object* v_res_5_; 
v_res_5_ = l_Lake_OpaqueTargetConfig_nonemptyType___redArg();
return v_res_5_;
}
}
LEAN_EXPORT lean_object* l_Lake_OpaqueTargetConfig_nonemptyType(lean_object* v_pkgName_6_, lean_object* v_name_7_){
_start:
{
...
LEAN_EXPORT lean_object* l_Lake_OpaqueTargetConfig_nonemptyType___boxed(lean_object* v_pkgName_9_, lean_object* v_name_10_){
_start:
{
lean_object* v_res_11_; 
v_res_11_ = l_Lake_OpaqueTargetConfig_nonemptyType(v_pkgName_9_, v_name_10_);
lean_dec(v_name_10_);
