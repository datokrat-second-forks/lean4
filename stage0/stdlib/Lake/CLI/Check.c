...
v_leanPrefix_1991_ = lean_ctor_get(v___y_1988_, 6);
...
v___x_2004_ = l___private_Lake_CLI_Check_0__Lake_Check_runSandBoxedExitCode(v___x_2003_, v___y_1988_);
