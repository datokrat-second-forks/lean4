...
noncomputable def entryAtIdxV [TransCmp cmp] [Nonempty (α × β)] (t : ExtTreeMap α β cmp)
    (n : Nat) : α × β :=
...
noncomputable def getEntryGEV [TransCmp cmp] [Nonempty (α × β)] (t : ExtTreeMap α β cmp)
    (k : α) : α × β :=
  t.getEntryGED k Classical.ofNonempty

@[inherit_doc ExtDTreeMap.Const.getEntryGTV]
noncomputable def getEntryGTV [TransCmp cmp] [Nonempty (α × β)] (t : ExtTreeMap α β cmp)
    (k : α) : α × β :=
  t.getEntryGTD k Classical.ofNonempty

@[inherit_doc ExtDTreeMap.Const.getEntryLEV]
noncomputable def getEntryLEV [TransCmp cmp] [Nonempty (α × β)] (t : ExtTreeMap α β cmp)
    (k : α) : α × β :=
  t.getEntryLED k Classical.ofNonempty

@[inherit_doc ExtDTreeMap.Const.getEntryLTV]
noncomputable def getEntryLTV [TransCmp cmp] [Nonempty (α × β)] (t : ExtTreeMap α β cmp)
    (k : α) : α × β :=
