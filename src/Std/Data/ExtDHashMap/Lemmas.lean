...
theorem get?_eq_some_iff [LawfulBEq α] {k : α} {v : β k} :
    m.get? k = some v ↔ ∃ h : m.contains k, haveI : Nonempty (β k) := ⟨m.get k h⟩; m.getV k = v :=
...
theorem get?_eq_some_iff_get [LawfulBEq α] {k : α} {v : β k} :
  ...
  m.inductionOn fun _ => DHashMap.get?_eq_some_iff_get
...
theorem get?_eq_some_iff_get [EquivBEq α] [LawfulHashable α] {k : α} {v : β} :
  ...
  m.inductionOn fun _ => DHashMap.Const.get?_eq_some_iff_get
...
@[grind =] theorem getV_insert [LawfulBEq α] {k a : α} {_ : Nonempty (β a)}
    {v : β k} :
    (m.insert k v).getV a =
      if h : k == a then cast (congrArg β (eq_of_beq h)) v
      else m.getV a :=
  m.inductionOn fun _ => DHashMap.getV_insert
...
theorem getV_insert_self [LawfulBEq α] {k : α} {v : β k} :
  ...
  m.inductionOn fun _ => DHashMap.getV_insert_self
...
theorem get?_eq_some_getV [LawfulBEq α] {a : α} (h' : m.contains a) :
  ...
  m.inductionOn (fun _ h' => DHashMap.get?_eq_some_getV h') h'

theorem get?_eq_some_get [LawfulBEq α] {a : α} (h') : m.get? a = some (m.get a h') :=
  m.inductionOn (fun _ => DHashMap.get?_eq_some_get) h'

theorem getV_eq_getV_get? [LawfulBEq α] {a : α} {_ : Nonempty (β a)} :
    m.getV a = (m.get? a).getV :=
  m.inductionOn fun _ => DHashMap.getV_eq_getV_get?
...
@[grind =] theorem getV_insert [EquivBEq α] [LawfulHashable α] {k a : α} {v : β} :
  ...
  m.inductionOn fun _ => DHashMap.Const.getV_insert
...
theorem getV_insert_self [EquivBEq α] [LawfulHashable α] {k : α} {v : β} :
  ...
  m.inductionOn fun _ => DHashMap.Const.getV_insert_self
...
theorem getV_erase [EquivBEq α] [LawfulHashable α] {k a : α} (h' : (m.erase k).contains a) :
  ...
  m.inductionOn (fun _ h' => DHashMap.Const.getV_erase h') h'
...
theorem getV_eq_getV [LawfulBEq α] {a : α} {_ : Nonempty β} :
    getV m a = m.getV a :=
  m.inductionOn fun _ => DHashMap.Const.getV_eq_getV
...
theorem getV_eq_get! [LawfulBEq α] {a : α} [Inhabited (β a)]
    (h' : m.contains a) :
    m.getV a = m.get! a :=
  m.inductionOn (fun _ h' => DHashMap.getV_eq_get! h') h'
...
theorem getV_eq_get! [EquivBEq α] [LawfulHashable α] [Inhabited β] {a : α} (h' : m.contains a) :
    getV m a = get! m a :=
  m.inductionOn (fun _ h' => DHashMap.Const.getV_eq_get! h') h'
...
theorem getV_eq_getD [LawfulBEq α] {a : α} {fallback : β a}
    (h' : m.contains a) :
    haveI : Nonempty (β a) := ⟨fallback⟩
    m.getV a = m.getD a fallback :=
  m.inductionOn (fun _ h' => DHashMap.getV_eq_getD h') h'
...
theorem getV_empty [LawfulBEq α] {a : α} {_ : Nonempty (β a)} :
    (∅ : ExtDHashMap α β).getV a = Classical.ofNonempty :=
  DHashMap.getV_emptyc

theorem getV_of_isEmpty [LawfulBEq α] {a : α} {_ : Nonempty (β a)} :
    m.isEmpty = true → m.getV a = Classical.ofNonempty :=
  m.inductionOn fun _ => DHashMap.getV_of_isEmpty
...
theorem getV_eq_getD [EquivBEq α] [LawfulHashable α] {a : α} {fallback : β} (h' : m.contains a) :
  ...
  m.inductionOn (fun _ h' => DHashMap.Const.getV_eq_getD h') h'
...
/- getV -/
@[simp, grind =]
theorem getV_empty [EquivBEq α] [LawfulHashable α] {_ : Nonempty β} {a : α} :
    getV (∅ : ExtDHashMap α (fun _ => β)) a = (Classical.ofNonempty : β) :=
  DHashMap.Const.getV_emptyc (a := a)

theorem getV_of_isEmpty [EquivBEq α] [LawfulHashable α] {_ : Nonempty β} {a : α} :
    m.isEmpty = true → getV m a = (Classical.ofNonempty : β) :=
  m.inductionOn fun _ => DHashMap.Const.getV_of_isEmpty
...
theorem getV_congr [EquivBEq α] [LawfulHashable α] {a b : α} {_ : Nonempty β} (hab : a == b) :
    getV m a = getV m b :=
  m.inductionOn (fun _ hab => DHashMap.Const.getV_congr hab) hab
...
theorem getKey?_of_isEmpty [EquivBEq α] [LawfulHashable α] {a : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKey?_of_isEmpty
...
theorem getKey?_eq_some_iff_getKey [EquivBEq α] [LawfulHashable α] {k k' : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKey?_eq_some_iff_getKey
...
@[grind =] theorem getKeyV_insert [EquivBEq α] [LawfulHashable α] {k a : α} {v : β k} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_insert
...
theorem getKeyV_insert_self [EquivBEq α] [LawfulHashable α] {a : α} {b : β a} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_insert_self
...
theorem getKeyV_erase [EquivBEq α] [LawfulHashable α] {k a : α} (h' : a ∈ m.erase k) :
  ...
  m.inductionOn (fun _ h' => DHashMap.getKeyV_erase h') h'
...
theorem getKeyV_beq [EquivBEq α] [LawfulHashable α] {k : α} (h' : k ∈ m) :
    m.getKeyV k == k :=
  m.inductionOn (fun _ h' => DHashMap.getKeyV_beq h') h'
...
theorem getKeyV_congr [EquivBEq α] [LawfulHashable α] {k k' : α} (h' : k == k') :
  ...
  m.inductionOn (fun _ h' => DHashMap.getKeyV_congr h') h'
...
theorem getKeyV_eq [LawfulBEq α] {k : α} (h' : k ∈ m) :
    m.getKeyV k = k :=
  m.inductionOn (fun _ h' => DHashMap.getKeyV_eq h') h'
...
theorem getKeyV_eq_ofNonempty [EquivBEq α] [LawfulHashable α] {a : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_eq_ofNonempty
...
theorem getKeyV_erase_self [EquivBEq α] [LawfulHashable α] {k : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_erase_self
...
theorem getKeyV_eq_getD_getKey? [EquivBEq α] [LawfulHashable α] {a : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_eq_getD_getKey?
...
theorem getKey_eq_getKeyV [EquivBEq α] [LawfulHashable α] {a : α} {h} :
  ...
  m.inductionOn (fun _ _ => DHashMap.getKey_eq_getKeyV) h
...
theorem getKeyV_eq_getKeyD_ofNonempty [EquivBEq α] [LawfulHashable α] {a : α} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_eq_getKeyD_ofNonempty
...
@[grind =] theorem getV_insertIfNew [LawfulBEq α] {k a : α} {v : β k}
    {_ : Nonempty (β a)} :
    (m.insertIfNew k v).getV a =
      if h₂ : k == a ∧ ¬k ∈ m then
        ...
        m.getV a :=
  m.inductionOn fun _ => DHashMap.getV_insertIfNew
...
@[grind =] theorem getV_insertIfNew [EquivBEq α] [LawfulHashable α] {k a : α} {v : β} :
    ...
    getV (m.insertIfNew k v) a =
      if k == a ∧ ¬k ∈ m then v else getV m a :=
  m.inductionOn fun _ => DHashMap.Const.getV_insertIfNew
...
@[grind =] theorem getKeyV_insertIfNew [EquivBEq α] [LawfulHashable α] {k a : α} {v : β k} :
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_insertIfNew
...
theorem getV_insertMany_list_of_contains_eq_false [LawfulBEq α]
  ...
  refine m.inductionOn (fun _ => ?_)
  simp only [insertMany_list_mk]
  exact DHashMap.getV_insertMany_list_of_contains_eq_false contains
...
theorem getV_insertMany_list_of_mem [LawfulBEq α]
  ...
  refine m.inductionOn (fun _ distinct mem => ?_) distinct mem
  simp only [insertMany_list_mk]
  exact DHashMap.getV_insertMany_list_of_mem k_beq distinct mem
...
theorem getKeyV_insertMany_list_of_contains_eq_false [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ => ?_)
  simp only [insertMany_list_mk]
  exact DHashMap.getKeyV_insertMany_list_of_contains_eq_false contains_eq_false
...
theorem getKeyV_insertMany_list_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ distinct mem => ?_) distinct mem
  simp only [insertMany_list_mk]
  exact DHashMap.getKeyV_insertMany_list_of_mem k_beq distinct mem
...
theorem getKeyV_insertMany_list_of_contains_eq_false [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ => ?_)
  simp only [insertMany_list_mk]
  exact DHashMap.Const.getKeyV_insertMany_list_of_contains_eq_false contains_eq_false
...
theorem getKeyV_insertMany_list_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ distinct mem => ?_) distinct mem
  simp only [insertMany_list_mk]
  exact DHashMap.Const.getKeyV_insertMany_list_of_mem k_beq distinct mem
...
theorem getV_insertMany_list_of_contains_eq_false [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ => ?_)
  simp only [insertMany_list_mk]
  exact DHashMap.Const.getV_insertMany_list_of_contains_eq_false contains_eq_false
...
theorem getV_insertMany_list_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn (fun _ distinct mem => ?_) distinct mem
  simp only [insertMany_list_mk]
  exact DHashMap.Const.getV_insertMany_list_of_mem k_beq distinct mem
...
theorem getKeyV_insertManyIfNewUnit_list_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn fun _ => ?_
  simp only [insertManyIfNewUnit_list_mk]
  exact DHashMap.Const.getKeyV_insertManyIfNewUnit_list_of_mem
...
theorem getKeyV_insertManyIfNewUnit_list_of_not_mem_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  refine m.inductionOn fun _ => ?_
  simp only [insertManyIfNewUnit_list_mk]
  exact DHashMap.Const.getKeyV_insertManyIfNewUnit_list_of_not_mem_of_mem k_beq
...
@[simp]
theorem getV_insertManyIfNewUnit_list [EquivBEq α] [LawfulHashable α] {l : List α} {k : α} :
...
theorem getV_ofList_of_mem [LawfulBEq α]
  ...
  DHashMap.getV_ofList_of_mem k_beq distinct mem
...
theorem getKeyV_ofList_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  DHashMap.getKeyV_ofList_of_mem k_beq distinct mem
...
theorem getKeyV_ofList_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    (mem : k ∈ l.map Prod.fst) :
    (ofList l).getKeyV k' = k :=
  DHashMap.Const.getKeyV_ofList_of_mem k_beq distinct mem
...
theorem getKeyV_unitOfList_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  DHashMap.Const.getKeyV_unitOfList_of_mem k_beq distinct mem
...
@[simp]
theorem getV_unitOfList [EquivBEq α] [LawfulHashable α] {l : List α} {k : α} :
    getV (unitOfList l) k = () :=
  Subsingleton.elim _ _
...
theorem getV_union_of_mem_right [LawfulBEq α]
  ...
  revert mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.getV_union_of_mem_right h
...
theorem getV_union_of_not_mem_left [LawfulBEq α]
    ...
    (m₁ ∪ m₂).getV k = m₂.getV k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ not_mem => DHashMap.getV_union_of_not_mem_left not_mem
...
theorem getV_union_of_not_mem_right [LawfulBEq α]
    ...
    (m₁ ∪ m₂).getV k = m₁.getV k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ not_mem => DHashMap.getV_union_of_not_mem_right not_mem
...
theorem getKeyV_union_of_mem_right [EquivBEq α] [LawfulHashable α]
  ...
  revert mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.getKeyV_union_of_mem_right h
...
theorem getKeyV_union_of_not_mem_left [EquivBEq α] [LawfulHashable α] {k : α}
    (not_mem : ¬k ∈ m₁) :
    (m₁ ∪ m₂).getKeyV k = m₂.getKeyV k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.getKeyV_union_of_not_mem_left h
...
theorem getKeyV_union_of_not_mem_right [EquivBEq α] [LawfulHashable α] {k : α}
    (not_mem : ¬k ∈ m₂) :
    (m₁ ∪ m₂).getKeyV k = m₁.getKeyV k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.getKeyV_union_of_not_mem_right h
...
theorem getV_union_of_mem_right [EquivBEq α] [LawfulHashable α]
  ...
  revert mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.Const.getV_union_of_mem_right h
...
theorem getV_union_of_not_mem_left [EquivBEq α] [LawfulHashable α] {_ : Nonempty β}
    ...
    Const.getV (m₁ ∪ m₂) k = Const.getV m₂ k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.Const.getV_union_of_not_mem_left h
...
theorem getV_union_of_not_mem_right [EquivBEq α] [LawfulHashable α] {_ : Nonempty β}
    ...
    Const.getV (m₁ ∪ m₂) k = Const.getV m₁ k := by
  revert not_mem
  exact m₁.inductionOn₂ m₂ fun _ _ h => DHashMap.Const.getV_union_of_not_mem_right h
...
@[grind =] theorem getV_diff [EquivBEq α] [LawfulHashable α]
    ...
    Const.getV (m₁ \ m₂) k = Const.getV m₁ k := by
  haveI : Nonempty β := ⟨Const.get (m₁ \ m₂) k h_mem⟩
  rw [← get_eq_getV (h := h_mem), get_diff,
    get_eq_getV (h := (mem_diff_iff.1 h_mem).1)]
...
theorem getV_alter [LawfulBEq α] {k k' : α}
    ...
    (m.alter k f).getV k' =
      if heq : k == k' then
        ...
        m.getV k' :=
  m.inductionOn (fun _ hc => DHashMap.getV_alter hc) hc
...
theorem getV_alter_self [LawfulBEq α] {k : α}
  ...
  m.inductionOn (fun _ hc => DHashMap.getV_alter_self hc) hc
...
theorem getKeyV_alter [LawfulBEq α] {k k' : α}
  ...
  m.inductionOn (fun _ hc => DHashMap.getKeyV_alter hc) hc

theorem getKey_alter [LawfulBEq α] [Inhabited α] {k k' : α}
    {f : Option (β k) → Option (β k)} {hc : k' ∈ m.alter k f} :
    (m.alter k f).getKey k' hc =
      if heq : k == k' then
        k
      else
        haveI h' : k' ∈ m := mem_alter_of_beq_eq_false (Bool.not_eq_true _ ▸ heq) |>.mp hc
        m.getKey k' h' :=
  m.inductionOn (fun _ _ => DHashMap.getKey_alter) hc

@[simp]
theorem getKeyV_alter_self [LawfulBEq α] {k : α}
    {f : Option (β k) → Option (β k)} (hc : k ∈ m.alter k f) :
    (m.alter k f).getKeyV k = k :=
  m.inductionOn (fun _ hc => DHashMap.getKeyV_alter_self hc) hc
...
theorem getV_alter [EquivBEq α] [LawfulHashable α] {k k' : α} {f : Option β → Option β}
    ...
    Const.getV (Const.alter m k f) k' =
      if k == k' then
        ...
        Const.getV m k' :=
  m.inductionOn (fun _ hc => DHashMap.Const.getV_alter hc) hc
...
theorem getV_alter_self [EquivBEq α] [LawfulHashable α] {k : α} {f : Option β → Option β}
  ...
  m.inductionOn (fun _ hc => DHashMap.Const.getV_alter_self hc) hc
...
theorem getKeyV_alter [EquivBEq α] [LawfulHashable α] {k k' : α} {f : Option β → Option β}
    ...
    (Const.alter m k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  m.inductionOn (fun _ hc => DHashMap.Const.getKeyV_alter hc) hc
...
theorem getKeyV_alter_self [EquivBEq α] [LawfulHashable α] {k : α} {f : Option β → Option β}
  ...
  m.inductionOn (fun _ hc => DHashMap.Const.getKeyV_alter_self hc) hc
...
theorem getV_modify [LawfulBEq α] {k k' : α} {f : β k → β k} (hc : k' ∈ m.modify k f) :
    ...
    (m.modify k f).getV k' =
      if heq : k == k' then
        ...
        m.getV k' :=
  m.inductionOn (fun _ hc => DHashMap.getV_modify hc) hc
...
theorem getV_modify_self [LawfulBEq α] {k : α} {f : β k → β k} (hc : k ∈ m.modify k f) :
  ...
  m.inductionOn (fun _ hc => DHashMap.getV_modify_self hc) hc
...
theorem getKeyV_modify [LawfulBEq α] {k k' : α} {f : β k → β k}
    ...
    (m.modify k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  m.inductionOn (fun _ hc => DHashMap.getKeyV_modify hc) hc

@[simp]
theorem getKeyV_modify_self [LawfulBEq α] {k : α} {f : β k → β k}
    (hc : k ∈ m.modify k f) : (m.modify k f).getKeyV k = k :=
  m.inductionOn (fun _ hc => DHashMap.getKeyV_modify_self hc) hc
...
theorem getV_modify [EquivBEq α] [LawfulHashable α] {k k' : α} {f : β → β}
    ...
    Const.getV (Const.modify m k f) k' =
      if k == k' then
        ...
        Const.getV m k' :=
  m.inductionOn (fun _ hc => DHashMap.Const.getV_modify hc) hc
...
theorem getV_modify_self [EquivBEq α] [LawfulHashable α] {k : α} {f : β → β}
  ...
  m.inductionOn (fun _ hc => DHashMap.Const.getV_modify_self hc) hc
...
theorem getKeyV_modify [EquivBEq α] [LawfulHashable α] {k k' : α} {f : β → β}
    ...
    (Const.modify m k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  m.inductionOn (fun _ h => DHashMap.Const.getKeyV_modify h) h
...
theorem getKeyV_modify_self [EquivBEq α] [LawfulHashable α] {k : α} {f : β → β}
  ...
  m.inductionOn (fun _ h => DHashMap.Const.getKeyV_modify_self h) h
...
theorem isSome_apply_of_mem_filterMap_get [LawfulBEq α]
  ...
  m.inductionOn fun _ => DHashMap.isSome_apply_of_mem_filterMap_get
...
theorem getV_filterMap [LawfulBEq α]
  ...
  m.inductionOn (fun _ h' => DHashMap.getV_filterMap h') h'
...
theorem getKeyV_filterMap [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn (fun _ h' => DHashMap.getKeyV_filterMap h') h'
...
theorem mem_filterMap_iff_getKey_get [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn fun _ => DHashMap.Const.mem_filterMap_iff_getKey_get
...
theorem isSome_apply_of_mem_filterMap_getKey_get [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn fun _ => DHashMap.Const.isSome_apply_of_mem_filterMap_getKey_get
...
theorem getV_filterMap [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn (fun _ h' => DHashMap.Const.getV_filterMap h') h'
...
theorem mem_filter_key_iff_getKey [EquivBEq α] [LawfulHashable α] {f : α → Bool} {k : α} :
    k ∈ m.filter (fun a _ => f a) ↔ ∃ h : k ∈ m, f (m.getKey k h) :=
  m.inductionOn fun _ => DHashMap.mem_filter_key_iff_getKey
...
theorem filter_key_equiv_self_iff [EquivBEq α] [LawfulHashable α] {f : (a : α) → Bool} :
    m.filter (fun k _ => f k) = m ↔ ∀ (k : α) (_ : k ∈ m), f (m.getKeyV k) :=
...
theorem getKeyV_filter [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn (fun _ h' => DHashMap.getKeyV_filter (h' := h')) h'
...
theorem get?_filter' [LawfulBEq α]
    {f : α → β → Bool} {k : α} :
    Const.get? (m.filter f) k = (Const.get? m k).filter (f k) :=
  m.inductionOn fun _ => DHashMap.Const.get?_filter'
...
theorem getV_filter [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn (fun _ h' => DHashMap.Const.getV_filter h') h'
...
theorem getV_map [LawfulBEq α]
  ...
  m.inductionOn (fun _ h' => DHashMap.getV_map h') h'
...
theorem getKeyV_map [EquivBEq α] [LawfulHashable α]
  ...
  m.inductionOn fun _ => DHashMap.getKeyV_map
...
theorem getV_map [LawfulBEq α]
  ...
  m.inductionOn (fun _ h' => DHashMap.Const.getV_map h') h'
