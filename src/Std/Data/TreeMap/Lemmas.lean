...
@[grind =] theorem contains_minKeyV [TransCmp cmp] {_ : Nonempty α} (he : t.isEmpty = false) :
...
@[grind =] theorem contains_maxKeyV [TransCmp cmp] {_ : Nonempty α} (he : t.isEmpty = false) :
