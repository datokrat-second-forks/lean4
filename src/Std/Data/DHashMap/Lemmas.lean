...
theorem get?_eq_some_iff [LawfulBEq α] {k : α} {v : β k} :
    m.get? k = some v ↔ ∃ h : k ∈ m, haveI : Nonempty (β k) := ⟨m.get k h⟩; m.getV k = v :=
...
theorem get?_eq_some_iff [EquivBEq α] [LawfulHashable α] {k : α} {v : β} :
    get? m k = some v ↔
      ∃ h : k ∈ m, haveI : Nonempty β := ⟨get m k h⟩; getV m k = v :=
...
@[simp, grind =]
theorem getV_erase [LawfulBEq α] {k a : α} (h' : a ∈ m.erase k) :
...
theorem get?_eq_some_getV [LawfulBEq α] {a : α} (h' : a ∈ m) :
...
@[simp, grind =]
theorem getV_erase [EquivBEq α] [LawfulHashable α] {k a : α} (h' : a ∈ m.erase k) :
...
theorem get?_eq_some_getV [EquivBEq α] [LawfulHashable α] {a : α} (h' : a ∈ m) :
...
theorem getV_eq_get! [LawfulBEq α] {a : α} [Inhabited (β a)] (h' : a ∈ m) :
    m.getV a = m.get! a :=
...
theorem getV_eq_get! [EquivBEq α] [LawfulHashable α] [Inhabited β] {a : α} (h' : a ∈ m) :
    getV m a = get! m a :=
...
theorem getV_eq_getD [LawfulBEq α] {a : α} {fallback : β a} (h' : a ∈ m) :
...
theorem getEntry_eq_getEntryV [EquivBEq α] [LawfulHashable α] {a : α} {h} :
  ...
  Raw₀.getEntry_eq_getEntryV ⟨m.1, _⟩ m.2
...
theorem getV_eq_getD [EquivBEq α] [LawfulHashable α] {a : α} {fallback : β} (h' : a ∈ m) :
...
theorem getKey?_eq_some_iff [EquivBEq α] [LawfulHashable α] {k k' : α} :
    m.getKey? k = some k' ↔ k ∈ m ∧ m.getKeyV k = k' :=
...
@[simp]
theorem getKeyV_insert_self [EquivBEq α] [LawfulHashable α] {k : α} {v : β k} :
    (m.insert k v).getKeyV k = k :=
...
theorem getKeyV_beq [EquivBEq α] [LawfulHashable α] {k : α} (h' : k ∈ m) : m.getKeyV k == k :=
...
theorem getKeyV_eq_ofNonempty [EquivBEq α] [LawfulHashable α] {a : α} :
  ...
  Raw₀.getKeyV_eq_ofNonempty ⟨m.1, _⟩ m.2
...
theorem getKey_eq_getKeyV [EquivBEq α] [LawfulHashable α] {a : α} {h} :
  ...
  Raw₀.getKey_eq_getKeyV ⟨m.1, _⟩ m.2
...
@[grind =] theorem getV_insertIfNew [LawfulBEq α] {k a : α} {_ : Nonempty (β a)} {v : β k} :
...
@[grind =] theorem getV_insertIfNew [EquivBEq α] [LawfulHashable α] {k a : α} {v : β} :
    haveI : Nonempty β := ⟨v⟩
...
@[grind =] theorem getKeyV_insertIfNew [EquivBEq α] [LawfulHashable α] {k a : α} {v : β k} :
...
theorem getV_insertMany_list_of_contains_eq_false [LawfulBEq α]
  ...
  Raw₀.getV_insertMany_list_of_contains_eq_false ⟨m.1, _⟩ m.2 contains_eq_false
...
theorem getV_insertMany_list_of_mem [LawfulBEq α]
    ...
    (m.insertMany l).getV k' = cast (by congr; apply LawfulBEq.eq_of_beq k_beq) v :=
...
theorem getV_union_of_not_mem_left [LawfulBEq α]
    ...
    (m₁ ∪ m₂).getV k = m₂.getV k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.getV_union_of_contains_eq_false_left _ _ _ _ ⟨m₁.1, _⟩ ⟨m₂.1, m₂.2.size_buckets_pos⟩ _ m₁.2 m₂.2 k not_mem
...
theorem getV_union_of_not_mem_right [LawfulBEq α]
    ...
    (m₁ ∪ m₂).getV k = m₁.getV k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.getV_union_of_contains_eq_false_right _ _ _ _ ⟨m₁.1, _⟩ ⟨m₂.1, m₂.2.size_buckets_pos⟩ _ m₁.2 m₂.2 k not_mem
...
theorem getKeyV_union_of_not_mem_left [EquivBEq α] [LawfulHashable α]
    ...
    (m₁ ∪ m₂).getKeyV k = m₂.getKeyV k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.getKeyV_union_of_contains_eq_false_left _ _ _ _ ⟨m₁.1, m₁.2.size_buckets_pos⟩ ⟨m₂.1, m₂.2.size_buckets_pos⟩ _ _ m₁.2 m₂.2 k not_mem
...
theorem getKeyV_union_of_not_mem_right [EquivBEq α] [LawfulHashable α]
    ...
    (m₁ ∪ m₂).getKeyV k = m₁.getKeyV k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.getKeyV_union_of_contains_eq_false_right _ _ _ _ ⟨m₁.1, m₁.2.size_buckets_pos⟩ ⟨m₂.1, m₂.2.size_buckets_pos⟩ _ _ m₁.2 m₂.2 k not_mem
...
theorem getV_union_of_not_mem_left [EquivBEq α] [LawfulHashable α]
    {_ : Nonempty β} {k : α} (not_mem : ¬k ∈ m₁) :
    Const.getV (m₁.union m₂) k = Const.getV m₂ k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.Const.getV_union_of_contains_eq_false_left _ _ _ _ ⟨m₁.1, _⟩ ⟨m₂.1, _⟩ _ _ m₁.2 m₂.2 k not_mem
...
theorem getV_union_of_not_mem_right [EquivBEq α] [LawfulHashable α]
    {_ : Nonempty β} {k : α} (not_mem : ¬k ∈ m₂) :
    Const.getV (m₁.union m₂) k = Const.getV m₁ k := by
  rw [← contains_eq_false_iff_not_mem] at not_mem
  exact @Raw₀.Const.getV_union_of_contains_eq_false_right _ _ _ _ ⟨m₁.1, _⟩ ⟨m₂.1, _⟩ _ _ m₁.2 m₂.2 k not_mem
...
/- getKey -/
theorem getKeyV_diff [EquivBEq α] [LawfulHashable α]
    {k : α} {h_mem : k ∈ m₁ \ m₂} :
    (m₁ \ m₂).getKeyV k = m₁.getKeyV k := by
  rw [mem_iff_contains] at h_mem
...
/- get -/
@[grind =] theorem getV_diff [EquivBEq α] [LawfulHashable α]
    {k : α} (h_mem : k ∈ m₁ \ m₂) :
    haveI : Nonempty β := ⟨Const.get (m₁ \ m₂) k h_mem⟩
...
theorem getKeyV_insertManyIfNewUnit_list_of_not_mem_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    ¬ k ∈ m → l.Pairwise (fun a b => (a == b) = false) → k ∈ l →
      (insertManyIfNewUnit m l).getKeyV k' = k :=
  Raw₀.Const.getKeyV_insertManyIfNewUnit_list_of_not_mem_of_mem ⟨m.1, _⟩ m.2 k_beq
...
theorem getKeyV_insertManyIfNewUnit_list_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    (insertManyIfNewUnit m l).getKeyV k = m.getKeyV k :=
  Raw₀.Const.getKeyV_insertManyIfNewUnit_list_of_mem ⟨m.1, _⟩ m.2 mem
...
theorem getV_ofList_of_mem [LawfulBEq α]
  ...
  Raw₀.getV_insertMany_emptyWithCapacity_list_of_mem k_beq distinct mem
...
theorem getKeyV_ofList_of_mem [EquivBEq α] [LawfulHashable α]
  ...
  Raw₀.getKeyV_insertMany_emptyWithCapacity_list_of_mem k_beq distinct mem
...
theorem getV_ofList_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    haveI : Nonempty β := ⟨v⟩
    getV (ofList l) k' = v :=
  Raw₀.Const.getV_insertMany_emptyWithCapacity_list_of_mem k_beq distinct mem
...
theorem getKeyV_ofList_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    (mem : k ∈ l.map Prod.fst) :
    (ofList l).getKeyV k' = k :=
  Raw₀.Const.getKeyV_insertMany_emptyWithCapacity_list_of_mem k_beq distinct mem
...
theorem getKeyV_unitOfList_of_mem [EquivBEq α] [LawfulHashable α]
    ...
    (distinct : l.Pairwise (fun a b => (a == b) = false))
    (mem : k ∈ l) :
    getKeyV (unitOfList l) k' = k :=
  Raw₀.Const.getKeyV_insertManyIfNewUnit_emptyWithCapacity_list_of_mem k_beq distinct mem
...
@[grind =]
theorem getV_alter [LawfulBEq α] {k k' : α}
    {f : Option (β k) → Option (β k)} (hc : k' ∈ m.alter k f) :
    haveI : Nonempty (β k') := ⟨(m.alter k f).get k' hc⟩
    (m.alter k f).getV k' =
      if heq : k == k' then
        haveI h' : (f (m.get? k)).isSome := mem_alter_of_beq heq |>.mp hc
        cast (congrArg β (eq_of_beq heq)) <| (f (m.get? k)).get h'
      else
        m.getV k' :=
  Raw₀.getV_alter ⟨m.1, _⟩ m.2 hc
...
@[simp]
theorem getV_alter_self [LawfulBEq α] {k : α}
    {f : Option (β k) → Option (β k)} (hc : k ∈ m.alter k f) :
    haveI h' : (f (m.get? k)).isSome := mem_alter_self.mp hc
    haveI : Nonempty (β k) := ⟨(f (m.get? k)).get h'⟩
    (m.alter k f).getV k = (f (m.get? k)).getV :=
  Raw₀.getV_alter_self ⟨m.1, _⟩ m.2 hc
...
@[grind =]
theorem getKeyV_alter [LawfulBEq α] {k k' : α}
    {f : Option (β k) → Option (β k)} (hc : k' ∈ m.alter k f) :
    (m.alter k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  Raw₀.getKeyV_alter ⟨m.1, _⟩ m.2 hc

theorem getKey_alter [LawfulBEq α] {k k' : α}
    {f : Option (β k) → Option (β k)} {h : k' ∈ m.alter k f} :
    (m.alter k f).getKey k' h =
      if heq : k == k' then k
      else
        haveI h' : k' ∈ m := mem_alter_of_beq_eq_false (Bool.not_eq_true _ ▸ heq) |>.mp h
        m.getKey k' h' :=
  Raw₀.getKey_alter ⟨m.1, _⟩ m.2

theorem getKeyV_alter_self [LawfulBEq α] {k : α}
    {f : Option (β k) → Option (β k)} (hc : k ∈ m.alter k f) :
    (m.alter k f).getKeyV k = k :=
  Raw₀.getKeyV_alter_self ⟨m.1, _⟩ m.2 hc
...
theorem getV_alter [EquivBEq α] [LawfulHashable α] {k k' : α} {f : Option β → Option β}
    (hc : k' ∈ Const.alter m k f) :
    haveI : Nonempty β := ⟨Const.get (Const.alter m k f) k' hc⟩
    getV (Const.alter m k f) k' =
      if k == k' then
        (f (Const.get? m k)).getV
      else
        getV m k' :=
  Raw₀.Const.getV_alter ⟨m.1, _⟩ m.2 hc
...
theorem getV_alter_self [EquivBEq α] [LawfulHashable α] {k : α} {f : Option β → Option β}
    (hc : k ∈ Const.alter m k f) :
    haveI h' : (f (Const.get? m k)).isSome := mem_alter_self.mp hc
    haveI : Nonempty β := ⟨(f (Const.get? m k)).get h'⟩
    getV (Const.alter m k f) k = (f (Const.get? m k)).getV :=
  Raw₀.Const.getV_alter_self ⟨m.1, _⟩ m.2 hc
...
theorem get_alter_self [EquivBEq α] [LawfulHashable α] {k : α} {f : Option β → Option β}
    ...
    haveI : Nonempty β := ⟨(f (Const.get? m k)).get h'⟩
    Const.get (Const.alter m k f) k h = (f (Const.get? m k)).getV := by
  simp [get_alter]
...
theorem getKeyV_alter [EquivBEq α] [LawfulHashable α] {k k' : α}
    {f : Option β → Option β} (hc : k' ∈ Const.alter m k f) :
    (Const.alter m k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  Raw₀.Const.getKeyV_alter ⟨m.1, _⟩ m.2 hc
...
@[simp]
theorem getKeyV_alter_self [EquivBEq α] [LawfulHashable α] {k : α}
    {f : Option β → Option β} (hc : k ∈ Const.alter m k f) :
    (Const.alter m k f).getKeyV k = k :=
  Raw₀.Const.getKeyV_alter_self ⟨m.1, _⟩ m.2 hc

theorem getKey_alter_self [EquivBEq α] [LawfulHashable α] {k : α}
    {f : Option β → Option β} {h : k ∈ Const.alter m k f} :
...
@[grind =]
theorem getV_modify [LawfulBEq α] {k k' : α} {f : β k → β k} (hc : k' ∈ m.modify k f) :
    haveI : Nonempty (β k') := ⟨(m.modify k f).get k' hc⟩
    (m.modify k f).getV k' =
      if heq : k == k' then
        haveI h' : k ∈ m := mem_congr heq |>.mpr <| mem_modify.mp hc
        haveI : Nonempty (β k) := ⟨m.get k h'⟩
        cast (congrArg β (eq_of_beq heq)) <| f (m.getV k)
      else
        m.getV k' :=
  Raw₀.getV_modify ⟨m.1, _⟩ m.2 hc
...
@[simp]
theorem getV_modify_self [LawfulBEq α] {k : α} {f : β k → β k} (hc : k ∈ m.modify k f) :
    haveI : Nonempty (β k) := ⟨(m.modify k f).get k hc⟩
    (m.modify k f).getV k = f (m.getV k) :=
  Raw₀.getV_modify_self ⟨m.1, _⟩ m.2 hc
...
theorem getKeyV_modify [LawfulBEq α] {k k' : α} {f : β k → β k}
    ...
    (m.modify k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  Raw₀.getKeyV_modify ⟨m.1, _⟩ m.2 hc

@[simp]
theorem getKeyV_modify_self [LawfulBEq α] {k : α} {f : β k → β k}
    (hc : k ∈ m.modify k f) : (m.modify k f).getKeyV k = k :=
  Raw₀.getKeyV_modify_self ⟨m.1, _⟩ m.2 hc
...
theorem getV_modify [EquivBEq α] [LawfulHashable α] {k k' : α} {f : β → β}
    ...
    Const.getV (Const.modify m k f) k' =
      if k == k' then
        ...
        Const.getV m k' :=
  Raw₀.Const.getV_modify ⟨m.1, _⟩ m.2 hc
...
theorem getV_modify_self [EquivBEq α] [LawfulHashable α] {k : α} {f : β → β}
  ...
  Raw₀.Const.getV_modify_self ⟨m.1, _⟩ m.2 hc
...
theorem getKeyV_modify [EquivBEq α] [LawfulHashable α] {k k' : α} {f : β → β}
    ...
    (Const.modify m k f).getKeyV k' =
      if k == k' then k else m.getKeyV k' :=
  Raw₀.Const.getKeyV_modify ⟨m.1, _⟩ m.2 hc
...
theorem getKeyV_modify_self [EquivBEq α] [LawfulHashable α] {k : α} {f : β → β}
    (hc : k ∈ Const.modify m k f) : (Const.modify m k f).getKeyV k = k :=
  Raw₀.Const.getKeyV_modify_self ⟨m.1, _⟩ m.2 hc
...
theorem isEmpty_filterMap_iff [EquivBEq α] [LawfulHashable α]
    {f : α → β → Option γ} :
    (m.filterMap f).isEmpty ↔ ∀ k h,
      haveI : Nonempty β := ⟨get m k h⟩
      f (m.getKeyV k) (getV m k) = none :=
  Raw₀.Const.isEmpty_filterMap_iff ⟨m.1, _⟩ m.2

theorem isEmpty_filterMap_eq_false_iff [EquivBEq α] [LawfulHashable α]
    {f : α → β → Option γ} :
    (m.filterMap f).isEmpty = false ↔ ∃ k h,
      haveI : Nonempty β := ⟨get m k h⟩
      (f (m.getKeyV k) (getV m k)).isSome :=
...
theorem getKey!_filterMap [EquivBEq α] [LawfulHashable α] [Inhabited α]
    ...
    (m.filterMap f).getKey! k =
    ((m.getKey? k).pfilter (fun x h' =>
      haveI : Nonempty β := ⟨Const.get m x (mem_of_getKey?_eq_some h')⟩
      (f x (Const.getV m x)).isSome)).get! :=
  Raw₀.Const.getKey!_filterMap ⟨m.1, _⟩ m.2
...
theorem getKeyD_filterMap [EquivBEq α] [LawfulHashable α]
    ...
    ((m.getKey? k).pfilter (fun x h' =>
      haveI : Nonempty β := ⟨Const.get m x (mem_of_getKey?_eq_some h')⟩
      (f x (Const.getV m x)).isSome)).getD fallback :=
...
theorem getKeyV_filter [EquivBEq α] [LawfulHashable α]
  ...
  Raw₀.getKeyV_filter ⟨m.1, _⟩ m.2 (h' := h')
...
theorem get!_filter' [LawfulBEq α] [Inhabited β]
    {f : α → β → Bool} {k : α} :
    Const.get! (m.filter f) k = ((Const.get? m k).filter (f k)).get! :=
  Raw₀.Const.get!_filter' ⟨m.1, _⟩ m.2
...
theorem getD_filter' [LawfulBEq α]
    {f : α → β → Bool} {k : α} {fallback : β} :
    Const.getD (m.filter f) k fallback = ((Const.get? m k).filter (f k)).getD fallback :=
  Raw₀.Const.getD_filter' ⟨m.1, _⟩ m.2
